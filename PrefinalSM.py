...
class StudentManager:
    ...
    def update_student(self):
        ...
        if field not in ("name", "grade", "age", "gender", "email", "phone"):
            print(Fore.RED + " Invalid field.")
            return
        new_val = input(f"Enter new value for {field}: ").strip()
        # validate
        if field == "name":
            if not is_valid_name(new_val): return print(Fore.RED + " Invalid name.")
            s["name"] = new_val
        elif field == "grade":
            norm = normalize_class_name(new_val)
            if not norm: return print(Fore.RED + " Invalid class.")
            s["grade"] = norm
        elif field == "age":
            if not is_valid_age(new_val): return print(Fore.RED + " Invalid age.")
            s["age"] = int(new_val)
        elif field == "gender":
            if not is_valid_gender(new_val): return print(Fore.RED + " Invalid gender.")
            s["gender"] = new_val.title()
        elif field == "email":
            if not is_valid_email(new_val): return print(Fore.RED + " Invalid email.")
            s["email"] = new_val
        elif field == "phone":
            if not is_valid_phone(new_val): return print(Fore.RED + " Invalid phone.")
            s["phone"] = new_val
...
class TeacherManager:
    ...
    def update_teacher(self):
        ...
        if field not in ("name", "experience", "qualifications"):
            print(Fore.RED + " Invalid field.")
            return
        new = input(f"Enter new {field}: ").strip()
        if field == "name":
            if not is_valid_name(new): return print(Fore.RED + " Invalid name.")
            t["name"] = new
        elif field == "experience":
            if not new.isdigit(): return print(Fore.RED + " Invalid experience.")
